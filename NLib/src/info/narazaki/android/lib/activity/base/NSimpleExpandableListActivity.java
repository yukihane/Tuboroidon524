...
abstract public class NSimpleExpandableListActivity extends NExpandableListActivity {
    ...
    public static class StatData {
        ...
        public StatData(final StatData stat) {
            super();
        ...
        public StatData(final PositionData pos_data, final ArrayList<Boolean> expand_stat_list) {
            super();
            pos_data_ = pos_data;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            if (savedInstanceState.containsKey(class_name + INTENT_KEY_RESUME_ITEM_PACKED_POS)) {
                ...
                final boolean[] list = savedInstanceState.getBooleanArray(class_name
                        + INTENT_KEY_RESUME_ITEM_EXPAND_STAT_LIST);
                for (final boolean data : list) {
    ...
    protected void onSaveInstanceState(final Bundle outState) {
        ...
        if (has_initial_data_) {
            ...
            if (resume_data_ != null) {
                ...
                final boolean[] list = new boolean[resume_data_.expand_stat_list_.size()];
    ...
    private void saveResumePosition() {
        ...
        if (resume_data_ == null && list_adapter_.getGroupCount() > 0) {
            ...
            final int group_count = list_adapter_.getGroupCount();
    ...
    public void setResumePosition(final StatData stat) {
