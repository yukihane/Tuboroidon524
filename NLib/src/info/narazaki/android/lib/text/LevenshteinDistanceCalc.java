...
public class LevenshteinDistanceCalc {
     ...
     *            GC発動なしに計算可能な文字列の長さ
     */
    public LevenshteinDistanceCalc(final int max_len) {
     ...
     * @param max_len
     */
    private void createBuffer(final int max_len) {
        max_len_ = max_len;
     ...
     * @return 編集距離の近さ
     */
    public final int similar(final String str1, final String str2) {
     ...
     * @return
     */
    public final int similarity(final String str1, final String str2) {
        final int max = str1.length() + str2.length();
    ...
    protected int calcONP(String str1, String str2) {
        ...
        final int offset = len1 + 1;
        final int delta = len2 - len1;
    ...
    private int snakeONP(final String str1, final String str2, final int k, int y) {
        int x = y - k;
