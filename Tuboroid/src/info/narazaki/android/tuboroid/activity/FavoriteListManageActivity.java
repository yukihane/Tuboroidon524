...
public class FavoriteListManageActivity extends TuboroidListActivity {
    ...
    void pickUp(final int position) {
        final FavoriteManageItemData target = ((FavoriteListManageAdapter) getListAdapter()).pickUp(position);
        final LinearLayout stack_box = (LinearLayout) findViewById(R.id.favorite_stack_box);
        stack_box.setVisibility(View.VISIBLE);

        final TextView stack_name = (TextView) stack_box.findViewById(R.id.favorite_stack_name);
    ...
    void pushDown(final int position) {
    ...
    public boolean onCreateOptionsMenu(final Menu menu) {
        ...
        // 削除
        final MenuItem delete_item = menu.add(0, MENU_KEY_APPLY_DELETE, MENU_KEY_APPLY_DELETE,
