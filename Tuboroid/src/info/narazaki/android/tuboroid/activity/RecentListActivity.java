...
public class RecentListActivity extends FavoriteListBaseActivity {
    ...
    protected void onListItemClick(final ListView l, final View v, final int position, final long id) {
        final ThreadData thread_data = ((RecentListAdapter) getListAdapter()).getData(position);
        if (thread_data == null) {
    ...
    public boolean onContextItemSelected(final MenuItem item) {
        ...
        final ThreadData thread_data = ((RecentListAdapter) getListAdapter()).getData(info.position);
        if (thread_data == null)
            return true;
    ...
    public boolean onCreateOptionsMenu(final Menu menu) {
        ...
        final MenuItem order_item = menu.add(0, MENU_KEY_CACHE_ORDER, MENU_KEY_CACHE_ORDER,
        ...
        // キャッシュ削除ボタン
        final MenuItem clear_item = menu.add(0, MENU_KEY_CLEAR_CACHE, MENU_KEY_CLEAR_CACHE,
    ...
    private void showDialogCacheOrder() {
        final String[] menu_strings = new String[] { getString(R.string.label_submenu_recent_read),
    ...
    public void deleteFilled() {
        ((RecentListAdapter) getListAdapter()).deleteFilled(new RecentListAdapter.DeleteFilledCallback() {
            @Override
            public void onDeleted(final ArrayList<ThreadData> deleteList) {
