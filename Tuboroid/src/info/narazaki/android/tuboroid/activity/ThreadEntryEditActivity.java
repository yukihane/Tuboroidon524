...
public class ThreadEntryEditActivity extends TuboroidActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        final String default_name = pref.getString(PREF_KEY_ENTRY_EDIT_NAME, "");
        final String default_mail = pref.getString(PREF_KEY_ENTRY_EDIT_MAIL, "sage");
        final EditText name_view = (EditText) findViewById(R.id.entry_edit_name);
        name_view.setText(default_name);

        final EditText mail_view = (EditText) findViewById(R.id.entry_edit_mail);
        mail_view.setText(default_mail);

        final EditText body_view = (EditText) findViewById(R.id.entry_edit_body);

        for (final EditText edit_text : new EditText[] { name_view, mail_view, body_view }) {
            ...
            public void onQuery(final ThreadData thread_data) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        final EditText entry_edit_body = (EditText) findViewById(R.id.entry_edit_body);
    ...
    protected void onPause() {
        ...
        // save name/mail
        final EditText entry_edit_name = (EditText) findViewById(R.id.entry_edit_name);
        final EditText entry_edit_mail = (EditText) findViewById(R.id.entry_edit_mail);
    ...
    private void createButtons() {
        // ボタンの初期化
        final ImageButton button_edit_name_clear = (ImageButton) findViewById(R.id.entry_edit_name_clear);
        ...
        final ImageButton button_edit_mail_clear = (ImageButton) findViewById(R.id.entry_edit_mail_clear);
        ...
        final Button button_edit_submit = (Button) findViewById(R.id.entry_edit_submit);
    ...
    public boolean onCreateOptionsMenu(final Menu menu) {
        ...
        // クリア
        final MenuItem compose_item = menu.add(0, MENU_KEY_CLEAR_BODY, MENU_KEY_CLEAR_BODY,
        ...
        compose_item.setOnMenuItemClickListener(new OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(final MenuItem item) {
                final Builder builder = new AlertDialog.Builder(ThreadEntryEditActivity.this);
        ...
        // sage
        final MenuItem sage_item = menu.add(0, MENU_KEY_CLEAR_BODY, MENU_KEY_CLEAR_BODY, getString(R.string.label_menu_sage));
        ...
        // 書き込み
        final MenuItem submit_item = menu.add(0, MENU_KEY_CLEAR_BODY, MENU_KEY_CLEAR_BODY,
    ...
    private void checkSubmitEntryPosting(final String name, final String value) {
        ...
        if (getTuboroidApplication().getAccountPref().use_p2_) {
            SimpleDialog.showYesEtcNo(this, R.string.dialog_post_notice_title, R.string.dialog_do_you_post_it_title,
                    R.string.dialog_label_normal, R.string.dialog_label_with_p2, new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(final DialogInterface dialog, final int which) {
    ...
    /*
     * public void retrySubmitEntryPosting(final String name, final String
     * value, String message) { if (!is_active_) return;
     * progress_dialog_.hide(); SimpleDialog.showYesNo(this,
     * R.string.dialog_post_notice_title, message, new
     * DialogInterface.OnClickListener() {
     * 
     * @Override public void onClick(DialogInterface dialog, int which) {
     * submitEntryPosting(name, value, true); } }, new
    ...
    private void submitEntryPosting(final String name, final String value, final boolean is_retry, final boolean with_p2) {
        ...
        final PostEntryData post_entry_data = new PostEntryData(entry_edit_name.getText().toString(), entry_edit_mail
    ...
    private void postEntry(final PostEntryData post_entry_data, final boolean with_p2) {
        ...
        pending_ = getAgent().postEntry(thread_data_, post_entry_data,
                with_p2 ? getTuboroidApplication().getAccountPref() : null, new PostEntryTask.OnPostEntryCallback() {
    ...
    private void onPostRetryNotice(final PostEntryData retryPostEntryData, final String message, final boolean with_p2) {
        if (!is_active_)
            return;
        pending_ = null;
