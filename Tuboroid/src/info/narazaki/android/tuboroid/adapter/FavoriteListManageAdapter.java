...
public class FavoriteListManageAdapter extends SimpleListAdapterBase<FavoriteManageItemData> {
    ...
    public FavoriteListManageAdapter(final Activity activity, final TuboroidApplication.ViewConfig view_config) {
        super();
        activity_ = activity;
    ...
    @Override
    protected View createView(final FavoriteManageItemData data) {
    ...
    @Override
    protected View setView(final View view, final FavoriteManageItemData data, final ViewGroup parent) {
        return data.setView(view, view_config_);
    }

    public FavoriteManageItemData pickUp(final int position) {
        final FavoriteManageItemData target = data_list_.get(position);
        data_list_.remove(position);
        return target;
    }

    public void pushDown(final int position, final FavoriteManageItemData target) {
        data_list_.add(position, target);
    }

    public void pushDown(final FavoriteManageItemData target) {
    ...
    public ArrayList<FavoriteItemData> commitDelete() {
        ...
        for (final FavoriteManageItemData data : data_list_) {
            if (data.checked_) {
