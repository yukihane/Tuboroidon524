...
public class Find2chAgent {
    ...
    static class Find2chCacheData {
        ...
        public Find2chCacheData(final String cachedKey, final ArrayList<Find2chResultData> listCache) {
            super();
    ...
    public Find2chAgent(final TuboroidAgentManager agent_manager) {
        super();
    ...
    public Find2chTask searchViaFind2ch(final String key, final int order, final boolean force_reload,
        ...
        final Find2chTask find_2ch_task = new Find2chTask(agent_manager_.getContext(), agent_manager_.getMultiHttpAgent());
        find_2ch_task.searchViaFind2ch(key, order, new Find2chTask.Find2chFetchedCallback() {

            @Override
            public void onReceived(final ArrayList<Find2chResultData> dataList) {
            ...
            @Override
            public void onFirstReceived(final int foundItems) {
