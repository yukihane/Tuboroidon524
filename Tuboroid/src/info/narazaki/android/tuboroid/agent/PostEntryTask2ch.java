...
public class PostEntryTask2ch extends PostEntryTask {
    ...
    public PostEntryTask2ch(final TuboroidAgentManager agent_manager) {
        super(agent_manager);
    }
    ...
    private void loginP2(final ThreadData thread_data, final PostEntryData post_entry_data,
        ...
        final HttpBoardLoginTask2chP2 task = new HttpBoardLoginTask2chP2(thread_data, account_pref,
    ...
    private void postEntry(final ThreadData thread_data, final PostEntryData post_entry_data, final String session_key,
        ...
        final HttpPostEntryTask2ch task = new HttpPostEntryTask2ch(thread_data, thread_data.getPostEntryURI(),
                ...
                new HttpPostEntryTask2ch.Callback() {
                    ...
                    @Override
                    public void onPostRetry(final PostEntryData retryPostEntryData) {
    ...
    private void postEntryByP2(final ThreadData thread_data, final PostEntryData post_entry_data,
        ...
        final HttpPostEntryTask2ch task = new HttpPostEntryTask2ch(thread_data, post_entry_uri, referer_uri, post_entry_data,
