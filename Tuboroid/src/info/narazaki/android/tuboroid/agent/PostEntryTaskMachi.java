...
public class PostEntryTaskMachi extends PostEntryTask {
    ...
    public PostEntryTaskMachi(final TuboroidAgentManager agent_manager) {
        super(agent_manager);
    }
    ...
    private void postEntry(final ThreadData thread_data, final PostEntryData post_entry_data,
        ...
        final HttpPostEntryTaskMachi task = new HttpPostEntryTaskMachi(thread_data, post_entry_data,
