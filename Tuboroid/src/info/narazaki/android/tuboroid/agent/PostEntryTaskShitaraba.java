...
public class PostEntryTaskShitaraba extends PostEntryTask {
    ...
    public PostEntryTaskShitaraba(final TuboroidAgentManager agent_manager) {
        super(agent_manager);
    }
    ...
    private void postEntry(final ThreadData thread_data, final PostEntryData post_entry_data,
        ...
        final HttpPostEntryTaskShitaraba task = new HttpPostEntryTaskShitaraba(thread_data, post_entry_data,
