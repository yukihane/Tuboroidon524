...
public class ThreadEntryListTaskShitaraba extends ThreadEntryListTask {
    ...
    public ThreadEntryListTaskShitaraba(final TuboroidAgentManager agent_manager) {
        super(agent_manager);
    }
    ...
    protected void doReloadSpecialThreadEntryList(final ThreadData thread_data, final AccountPref account_pref,
        ...
        final HttpGetThreadEntryListTaskShitarabaStorage task = new HttpGetThreadEntryListTaskShitarabaStorage(thread_data,
