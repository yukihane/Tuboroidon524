...
public class HttpCreateNewThreadTask2ch extends TextHttpPostTaskBase {
    ...
    public HttpCreateNewThreadTask2ch(final BoardData board_data, final String post_entry_uri,
            final String referer_uri, final NewThreadData new_thread_data,
            final HashMap<String, String> hidden_form_map, final Callback callback) {
