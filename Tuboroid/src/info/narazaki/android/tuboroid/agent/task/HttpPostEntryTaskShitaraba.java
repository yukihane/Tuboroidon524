...
public class HttpPostEntryTaskShitaraba extends TextHttpPostTaskBase {
    ...
    public HttpPostEntryTaskShitaraba(final ThreadData thread_data, final PostEntryData post_entry_data, final Callback callback) {
    ...
    protected boolean setRequestParameters(final HttpRequestBase req) {
        try {
            ...
            final String[] tags = thread_data_.server_def_.board_tag_.split("/");
            if (tags.length < 2)
                return false;
