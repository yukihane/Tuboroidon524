...
public class RecentThreadManageItemData implements NListAdapterDataInterface {
    ...
    public RecentThreadManageItemData(final ThreadData item) {
        super();
        item_ = item;
        checked_ = false;
    }
    ...
    public View setView(final View view, final TuboroidApplication.ViewConfig view_config, final ThreadData.ViewStyle style) {
        final LinearLayout thread_row = (LinearLayout) view.findViewById(R.id.recent_thread_row);
        ...
        final LinearLayout delete_button_box = (LinearLayout) view.findViewById(R.id.recent_thread_button_box);
