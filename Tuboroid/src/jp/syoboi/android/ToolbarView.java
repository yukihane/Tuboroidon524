...
public class ToolbarView extends LinearLayout {
    ...
    public static class ToolbarStyle {
        ...
        public ToolbarStyle(final Context context, final AttributeSet attrs, final int orientation) {
            ...
            face = new GradientDrawable(Orientation.TOP_BOTTOM,
            // orientation == LinearLayout.HORIZONTAL ? Orientation.TOP_BOTTOM :
